 ...
 * @property int|\DateTime $deliveryDate
 ...
 * @property bool $erotic
 * @property string $brand
 * @property string $categoryId
 * @property CategoryText[] $categoryTexts
 * @property string $product
 * @property string $itemType
 * @property ExtraMessage[] $extraMessages
 * @property ShopDepot[] $shopDepots
 * @property bool $visibility
 * @property string $customLabel
 * @property string $customLabel1
 * @property float $maxCpc
 * @property float $maxCpcSearch
